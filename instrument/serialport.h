...
#pragma endregion
		//public:
		//static SerialPort^ sp=gcnew SerialPort();
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		/*	this->sp->PortName = this->comboBox1->Text->Trim();
		this->sp->BaudRate = Single::Parse(this->comboBox2->Text->Trim());
		this->sp->DataBits = Int32::Parse(this->comboBox3->Text->Trim());
		this->sp->StopBits = StopBits::One;
		this->sp->Open();
		this->Close();*/
	}
			 //public: static System::Void OnDataReceived() { }
	};
}
