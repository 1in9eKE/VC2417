...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Text = L"请确保该数据库中的表结构符合程序要求！";
			// 
			// label6
			// 
			...
			this->label6->Text = L"具体要求请查看README.txt";
			// 
			// DBset
			// 
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
		if (System::Windows::Forms::DialogResult::Yes == MessageBox::Show(L"跳过此操作将使用默认数据库，无法多台电脑共享数据，是否确认跳过？", "提示", MessageBoxButtons::YesNo)) {
