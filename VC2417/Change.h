...
namespace VC2417 {
	...
	private: System::Windows::Forms::ToolStripMenuItem^  检验报告ToolStripMenuItem1;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->检验报告ToolStripMenuItem1 = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->menuStrip1->Size = System::Drawing::Size(688, 25);
			...
			this->另存为AToolStripMenuItem->Size = System::Drawing::Size(152, 22);
			...
			this->修改ToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {
				this->检验项目ToolStripMenuItem1,
					this->医生信息ToolStripMenuItem1, this->病人信息ToolStripMenuItem1, this->检验报告ToolStripMenuItem1
			});
			...
			// 
			// 检验报告ToolStripMenuItem1
			// 
			this->检验报告ToolStripMenuItem1->Name = L"检验报告ToolStripMenuItem1";
			this->检验报告ToolStripMenuItem1->Size = System::Drawing::Size(152, 22);
			this->检验报告ToolStripMenuItem1->Text = L"检验报告";
			// 
			// Change
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 12);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(688, 448);
